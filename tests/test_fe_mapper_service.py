...
def test_fe_mapper_agrupa_total_con_impuestos_desde_snapshot():
    ...
    venta = VentaRead(
        ...
        monto_iva=Decimal("13.20"),
        monto_ice=Decimal("2.50"),
        valor_total=Decimal("125.70"),
        detalles=[
            VentaDetalleRead(
                producto_id=uuid4(),
                descripcion="DET 1",
    ...
    assert payload["infoFactura"]["importeTotal"] == "125.70"
    ...
    assert {"codigo": "2", "codigoPorcentaje": "2", "baseImponible": "110.00", "valor": "13.20"} in total_con_impuestos
