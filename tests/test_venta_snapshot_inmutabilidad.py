...
from osiris.modules.facturacion.models import VentaRegistroCreate, VentaCompraDetalleRegistroCreate
...
def test_venta_historica_mantiene_snapshot_si_cambia_producto_impuesto():
    ...
    snapshot = next(obj for obj in added_objects if obj.__class__.__name__ == "VentaDetalleImpuestoSnapshot")
