...
from src.osiris.db.entities import empresa_entity, tipo_contribuyente_entity, punto_emision_entity, sucursal_entity, persona_entity, rol_entity, tipo_cliente_entity, cliente_entity, empleado_entity, usuario_entity
