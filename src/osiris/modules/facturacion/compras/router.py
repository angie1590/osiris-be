...
@router.post("/compras", response_model=CompraRead, status_code=status.HTTP_201_CREATED, tags=["Facturacion"])
...
@router.post("/compras/desde-productos", response_model=CompraRead, status_code=status.HTTP_201_CREATED, tags=["Facturacion"])
...
@router.put("/compras/{compra_id}", response_model=CompraRead, tags=["Facturacion"])
...
@router.post("/compras/{compra_id}/anular", response_model=CompraRead, tags=["Facturacion"])
...
@router.get("/v1/compras/{compra_id}/sugerir-retencion", response_model=RetencionSugeridaRead, tags=["Facturacion"])
...
@router.post("/v1/compras/{compra_id}/guardar-plantilla-retencion", tags=["Facturacion"])
...
@router.post("/v1/compras/{compra_id}/retenciones", response_model=RetencionRead, status_code=status.HTTP_201_CREATED, tags=["Facturacion"])
...
@router.post("/v1/retenciones/{retencion_id}/emitir", response_model=RetencionRead, tags=["Facturacion"])
...
@router.get("/v1/retenciones/{retencion_id}/fe-payload", tags=["Facturacion"])
