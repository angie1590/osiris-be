...
from osiris.modules.facturacion.entity import EstadoVenta, Venta, VentaDetalle
from osiris.modules.facturacion.models import ReporteTopProductoRead, ReporteVentasResumenRead, q2
